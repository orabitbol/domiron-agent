...
מבנה:
1. שורת פתיחה שמחזקת את ההוק — מעמיקה את הכאב או האיום
2. 2–4 שורות שבונות מתח — כל שורה דוחפת את הקורא הלאה
3. שורת סיום שגורמת לתחושת "אני חייב לפעול עכשיו"
4. רווח + CTA

שורות קצרות וקצביות. לא רשימות. לא פסקאות.
כל מספר חייב להגיע מ"עובדות המשחק" — ולשרת את הרגש, לא להוביל אותו.
אסור שהכיתוב ירגיש כמו מדריך, הסבר, או סקירת מוצר.
הכיתוב חייב להרגיש כמו שחקן חד שמדבר לשחקן אחר.
...
כתוב כמו שחקן חד שמדבר לשחקנים — לא כמו מערכת, לא כמו מדריך, לא כמו בוט.
תגרום לקורא להרגיש שהוא מפסיד עכשיו. שמישהו אחר מתחזק על חשבונו.
אל תסביר מכניקות. אל תפתח במספרים. אל תכתוב משפטים שמתאימים לכל משחק.
כל משפט חייב להכאיב, ללחוץ, או לגרום ל-FOMO.
אם זה נשמע כמו תיעוד מוצר — כתוב מחדש.
אם זה נשמע כמו שיווק גנרי — כתוב מחדש.
אם שחקן לא ירגיש שום דבר כשהוא קורא את זה — כתוב מחדש.
