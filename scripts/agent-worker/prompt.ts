...
שורה אחת. כאילו מישהו אמר לך משהו ברחוב.
לא מושלם. לא מנוסח. פשוט ישיר.
בלי מספרים בהתחלה. בלי הסברים.
מותר שאלה. מותר שבירה. מותר חוספה.
"הזהב שלך? חשוף." / "ישנת? שילמת." / "לא יודע מי — אבל מישהו תקף אותך בלילה."

## facebook_caption (חובה — עד 2,000 תווים)
הודעה לחבר שמפסיד ולא יודע. לא פוסט. הודעה.
אין מבנה קבוע. פשוט תמשיך לדבר אחרי ההוק.
שורה. עוד שורה. עוד דחיפה. CTA.
מותר שאלות באמצע. מותר משפט של מילה אחת. מותר לשבור קו.
הדבר היחיד שאסור — להרגיש "כתוב". מסודר. מתוכנן.
כל מספר — רק מ"עובדות המשחק". ותמיד אחרי הכאב, לא לפניו.
...
3–7 סליידים. כל סלייד = שורה אחת.
רצף מכות. כל אחת חזקה מהקודמת. בלי הסברים.
אם סלייד נשמע כמו שקופית — תמחק אותו.
...
אל תכתוב פוסט. תשלח הודעה.
כמו שהיית שולח לחבר — "אחי, ראית מה קרה לך?"
לא מסודר. לא מושלם. לא "כתוב טוב". פשוט אמיתי.
אם זה נשמע ככתוב — תמחק.
אם זה נשמע כמו פרסומת — תמחק.
אם זה מתאים לכל משחק — תמחק.
אם בן אדם לא ירגיש כלום — תמחק.
