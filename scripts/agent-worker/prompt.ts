...
## hook (חובה — 1 עד 4 מילים)
מילה אחת עד ארבע. "ישנת." / "חשוף." / "לקחו לך."

## facebook_caption (חובה — מקסימום 3 שורות)
מקסימום 4 מילים בשורה. מקסימום 3 שורות. לא יותר.
אם אפשר בשורה אחת — שורה אחת.
בלי רווחים. בלי שורות ריקות. נקי.
...
3–5 סליידים. 1–4 מילים לסלייד. מקסימום.
כל סלייד = מכה. אם מסביר — מחק.
...
מקסימום 4 מילים בשורה. מקסימום 3 שורות.
אם יותר ארוך — קצר. אם נשמע כמו AI — מחק.
פשוט תגיד. קצר. חד.
